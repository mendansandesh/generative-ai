...
> ⚠️ Note: Running these sample applications may incur charges depending on your usage of Google Cloud services such as Speech-to-Text, Text-to-Speech, and Vertex AI.
